...
\begin{figure}[!t]
\centerline{
a\includegraphics[width=0.25\textwidth]{Fig1a.pdf}
b\includegraphics[width=0.25\textwidth]{Fig1b.pdf}
c\includegraphics[width=0.25\textwidth]{Fig1c.pdf}}
\centerline{
d\includegraphics[width=0.25\textwidth]{Fig1d.pdf}
e\includegraphics[width=0.25\textwidth]{Fig1e.pdf}}

...
\begin{figure}[!t]
\centerline{
a\includegraphics[width=0.45\textwidth]{Fig1.pdf}
b\includegraphics[width=0.45\textwidth]{Fig2.pdf}
}
\centerline{
c\includegraphics[width=0.45\textwidth]{Fig3.pdf}
d\includegraphics[width=0.45\textwidth]{Fig4.pdf}
}
\centerline{
e\includegraphics[width=0.45\textwidth]{Fig5.pdf}
}
